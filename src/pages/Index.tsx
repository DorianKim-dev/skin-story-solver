...
const Index = () => {
  ...
  const Typography = ({ variant, children, className = '' }) => {
    if (variant === 'h2') {
      return <h2 className={`text-xl md:text-2xl ${className}`}>{children}</h2>;
    }
        ...
        <Container size="xl">
          <div className="relative z-10 flex items-center justify-center py-20 min-h-screen">
            ...
            >
              ...
              <Typography variant="h2" className="max-w-xl mx-auto text-white/90 text-center text-xl md:text-2xl">
      ...
      >
        <Container size="xl">
          <div 
            ...
            className={`flex flex-col items-center justify-center min-h-screen text-center space-y-8 transition-all duration-1000 ease-out scroll-reveal ${
          ...
          >
            ...
            {/* Default visible button (always visible) */}
            <Link to="/camera">
              <Button 
                size="lg" 
