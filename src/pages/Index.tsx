...
const Index = () => {
  ...
  return (
    <div className="theme-home-bright h-screen bg-white overflow-y-auto snap-y snap-mandatory scroll-root">
      ...
      <Section spacing="hero" className="relative snap-start section-animate bg-cover-center min-h-[85vh]" style={{ backgroundImage: 'url(/lovable-uploads/d9348ce3-7cdf-4342-9c5d-5b4695799d0a.png)', backgroundPosition: 'center 70%' }}>
        <Container size="xl">
          ...
          <div className="relative z-10 flex items-center justify-center py-20 min-h-[60vh]">
            <div ref={hero.ref} className={`w-full max-w-2xl text-center space-y-6 fade-enter ${hero.inView ? 'fade-enter-active' : ''} mt-28 md:mt-40`}>
              {/* Title + Subtitle */}
              <div className="text-2xl md:text-4xl text-white inline-block -translate-x-2 md:-translate-x-6 font-sans font-bold">Diagnose. Match. Heal.</div>

              <Typography variant="h2" className="max-w-xl mx-auto text-white/90">
                AI가 제안하는 당신만의 피부 솔루션
              </Typography>
              <Typography variant="h2" className="max-w-xl mx-auto text-white/80 text-balance">
                핵심만 담은 프리미엄 진단 경험
              </Typography>
            </div>
          </div>
